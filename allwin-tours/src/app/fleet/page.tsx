...
export const metadata: Metadata = {
  title: 'Our Fleet | Allwin Tours & Travels',
  description: 'AC vehicles with expert drivers — Innova Crysta, Sedan, Ertiga, Tempo Traveller, Mini Bus.',
};
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-text-grey max-w-2xl mx-auto mt-4">
            From sedans to mini buses, every vehicle in our fleet is clean,
            AC-equipped, and GPS tracked for your safety.
          </p>
        </div>
