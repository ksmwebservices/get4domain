...
export const metadata: Metadata = {
  ...
  description:
    "India's SaaS platform for professional business websites, digital marketing and business management. DomainApp for Business OS. DomainCampaign for Managed Marketing.",
  keywords: [
