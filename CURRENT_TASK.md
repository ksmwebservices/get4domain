...
```
Step 1:  ChatGPT generates Engineering Package (20 documents)
Step 2:  Documents placed in client docs/ folder
Step 3:  Claude Code receives P001 instruction
Step 4:  Claude Code reads all 6 session files
Step 5:  Claude Code reads all 20 docs/ documents
Step 6:  Claude Code executes P001 (project initialization only)
Step 7:  Claude Code reports completion
Step 8:  ChatGPT reviews and issues P003 prompt
```
...
ChatGPT must deliver all 20 files to client docs/ before P001:
