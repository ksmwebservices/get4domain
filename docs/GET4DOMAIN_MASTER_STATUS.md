...
### ✅ TeleCRM — working
Kanban-only (List view removed), gesture-native swipe/scroll on mobile, per-lead summary panel (no AI — real recorded notes/history only), non-AI follow-up reminders with due badges, demo leads confirmed syncing correctly.
