...
import { Globe, ExternalLink, Mail, Phone, CheckCircle2, Ban, Plus, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-400">{customers.length} customer{customers.length !== 1 ? 's' : ''}.</p>
        </div>
      </div>
