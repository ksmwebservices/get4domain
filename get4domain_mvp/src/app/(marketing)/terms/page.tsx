...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      sections={[
        { heading: '1. Acceptance of Terms', content: (<p>By accessing and using Get4Domain&apos;s platform and services (operated by KSM Quantum Technologies), you agree to be bound by these Terms &amp; Conditions. If you do not agree with any part of these terms, you must not use our services.</p>) },
        {
          heading: '2. Services',
          content: (
            <>
